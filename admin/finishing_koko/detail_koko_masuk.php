...
$id_koko_masuk = isset($_GET['id']) ? intval($_GET['id']) : 0;
...
$sql = "SELECT kk.*, pf.nama_petugas 
        ...
        WHERE kk.id_koko_masuk = ?";

$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $id_koko_masuk);
$stmt->execute();
$result = $stmt->get_result();
$koko_masuk = $result->fetch_assoc();
$stmt->close();

if (!$koko_masuk) {
    header("Location: list_koko_masuk.php");
    exit();
}
...
$sql_detail1 = "SELECT d.*, k.nama_koko 
                FROM detail_koko_masuk d
                JOIN koko k ON d.id_produk = k.id_produk
                WHERE d.id_koko_masuk = ?";
...
echo "<!-- Debug Info -->";
echo "<!-- id_koko_masuk: " . $id_koko_masuk . " -->";
echo "<!-- Query koko_masuk: SELECT p.*, r.nama_petugas FROM koko_masuk p JOIN petugas_finishing r ON p.id_petugas_finishing = r.id_petugas_finishing WHERE p.id_koko_masuk = $id_koko_masuk -->";
        ...
        <div class="pc-content">
            ...
            <div class="row">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2>DATA KOKO MASUK</h2>
                    <div>
                        <a href="list_koko_masuk.php" class="btn btn-secondary">
                                        ...
                                        <div class="col-md-4">
                                            <table class="table table-bordered">
                                                <tr>
                                                    ...
                                                    <td><?= $koko_masuk['nama_petugas'] ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Tanggal</th>
                                                    <td><?= dateIndo($koko_masuk['tanggal_koko_masuk']) . ' ' . date('H:i', strtotime($koko_masuk['tanggal_koko_masuk'])) ?></td>
                                                </tr>
                                        ...
                                        <div class="col-md-8">
                                            <table class="table table-bordered">
                                                <tr>
                                                    ...
                                                    <td><?= formatRupiah($koko_masuk['total_harga']) ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Status</th>
                                                    <td>
                                                        <?= ucfirst($koko_masuk['status']) ?>
                                                        <?php if ($koko_masuk['status'] == 'kirim'): ?> <br>
                                                            Dibayar: <?= formatRupiah($total_cicilan_info) ?> dari <?= formatRupiah($koko_masuk['total_harga']) ?>
                                                            <?php
                                                            $sisa_hutang = $koko_masuk['total_harga'] - $total_cicilan_info;
                                                            ?>
                                                            <br>
                                                ...
                                                <td><?= ucfirst($koko_masuk['metode_pembayaran']) ?></td>
                                            </tr> -->
                                            </table>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                        <h3>Daftar Produk</h3>
                                        <a href="nota.php?id=<?= $id_koko_masuk ?>" class="btn btn-danger" target="_blank">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th class="fs-6 text-center"><?= formatRupiah($koko_masuk['total_harga']) ?></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
