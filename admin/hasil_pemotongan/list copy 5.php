...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['simpan_hasil_jahit'])) {
        ...
        if (empty($tanggal_hasil_jahit)) {
            ...
            $error_modal = "Total upah harus lebih dari 0!";
        } elseif (empty($atk_nama[0])) { // Validasi minimal 1 ATK
            $error_modal = "Minimal satu ATK finishing harus diisi!";
        }
...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
                                ...
                                <div id="atk-container">
                                    ...
                                    <div class="atk-item row mb-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="atk_satuan[]" class="form-control">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(e) {
                ...
                if (e.target.closest('.btn-input-hasil-penjahitan')) {
                    ...
                    const seri = button.getAttribute('data-seri');
                    const totalPotong = button.getAttribute('data-total-potong');
                    const totalBordir = parseInt(button.getAttribute('data-total-bordir')) || 0; // AMBIL TOTAL BORDIR
                    ...
                    document.getElementById('modal_hasil_max_total').textContent = maxJahit;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let atkCounter = 1; // Mulai dari 1 karena sudah ada 1 item default
        ...
        `;
            ...
            document.getElementById('modalHasilPenjahitan').addEventListener('hidden.bs.modal', function() {
                ...
                // Tambahkan kembali item pertama
                if (firstAtkItem) {
                    // Reset nilai input pada item pertama
                    ...
                    atkContainer.appendChild(firstAtkItem);
                }

                atkCounter = 1;
            });

            // Event listener untuk tombol Input Hasil Jahit (jika ada di bagian lain)
            document.addEventListener('click', function(e) {
                if (e.target.closest('.btn-input-hasil-penjahitan')) {
                    // Reset ATK container saat modal dibuka
                    atkCounter = 1;

                    // Pastikan hanya ada 1 item ATK
                    const atkItems = document.querySelectorAll('.atk-item');
                    if (atkItems.length > 1) {
