                ...
                <ul class="list-unstyled">
                    <li class="dropdown pc-h-item header-user-profile">
                        <a
                            ...
                            aria-expanded="false">
                            <img
                                src="<?= $base_url ?>/assets/img/Logo-Biru.png"
                                alt="user-image"
                                class="user-avtar" />
                        ...
                        <div
                            ...
                            <div class="tab-content" id="mysrpTabContent">
                                <div
                                    ...
                                    tabindex="0">
                                    <a href="<?= $base_url ?>/admin/profile/index.php" class="dropdown-item">
                                        <i class="ti ti-user"></i>
                                        <span>Lihat Profil</span>
                                    </a>
                                    <a href="<?= $base_url ?>/admin/aktivitas.php" class="dropdown-item">
