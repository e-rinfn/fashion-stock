...
$is_transaksi_active = strpos($current_page, '/admin/transactions/in') !== false || strpos($current_page, '/admin/transactions/out') !== false;
?>
    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo d-flex align-items-center">
                    ...
                    <span class="fw-bold text-uppercase fs-4">Fashion Stock</span>
                </div>
                <div class="toggler">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item <?= strpos($current_page, '/admin/dashboard') !== false ? 'active' : '' ?>">
                ...
                <li class="sidebar-item <?= strpos($current_page, '/admin/products') !== false ? 'active' : '' ?>">
                ...
                <li class="sidebar-item <?= strpos($current_page, '/admin/supplier') !== false ? 'active' : '' ?>">
                ...
                <li class="sidebar-item has-sub <?= $is_transaksi_active ? 'active' : '' ?>">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-stack"></i>
                        <span>TRANSAKSI</span>
                    </a>
                    <ul class="submenu <?= $is_transaksi_active ? 'active' : '' ?>">
                        <li class="submenu-item <?= strpos($current_page, '/admin/transactions/in') !== false ? 'active' : '' ?>">
                            <a href="<?= $base_url ?>/admin/transactions/in/index.php">MASUK</a>
                        </li>
                        <li class="submenu-item <?= strpos($current_page, '/admin/transactions/out') !== false ? 'active' : '' ?>">
