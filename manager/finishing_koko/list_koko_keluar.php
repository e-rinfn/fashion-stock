...
$sql .= " ORDER BY p.tanggal_koko_keluar DESC";

$koko_keluar = query($sql);
?>
        ...
        <div class="pc-content">
            ...
            <div class="row">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div>
                        <a href="koko_keluar.php" class="btn btn-success">
                    ...
                    <form method="GET" class="row g-3 mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <?php if ($id_petugas_finishing > 0 || $status != 'all'): ?>
                                <a href="list_koko_keluar.php" class="btn btn-secondary ms-2">
                        ...
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <tbody>
                                <?php if (empty($koko_keluar)): ?>
                                    <tr>
                                        <td colspan="6" class="text-center">Tidak ada data koko keluar</td>
                                    </tr>
                                <?php else: ?>
                                    <?php $no = 1; ?>
                                    <?php foreach ($koko_keluar as $keluar): ?>
                                        <tr>
                                            <td class="text-center"><?= $no++ ?></td>
                                            <td><?= dateIndo($keluar['tanggal_koko_keluar']) ?></td>
                                            <td><?= htmlspecialchars($keluar['nama_petugas']) ?></td>
                                            <td><?= formatRupiah($keluar['total_harga']) ?></td>
                                            <td class="text-center">
                                                <?php if ($keluar['status_pembayaran'] == 'lunas'): ?>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group" role="group" aria-label="Aksi Penjualan">
                                                    ...
                                                    <button class="btn btn-sm btn-danger btn-batal" data-id="<?= $keluar['id_koko_keluar'] ?>" title="Batalkan Penjualan">
                                                        <i class="ti ti-circle-x"></i>
                                                    </button>
                                                    <a href="detail_koko_keluar.php?id=<?= $keluar['id_koko_keluar'] ?>" class="btn btn-sm btn-warning" title="Pembayaran">
                                                        <i class="ti ti-report-money"></i>
                                                    </a>
                                                    <!-- <a href="detail.php?id=<?= $keluar['id_koko_keluar'] ?>" class="btn btn-sm btn-primary" title="Detail">
                                                                <i class="bx bx-detail"></i>
                                                            </a> -->


                                                    <!-- <a href="nota.php?id=<?= $keluar['id_koko_keluar'] ?>" target="_blank" class="btn btn-sm btn-info" title="Nota">
