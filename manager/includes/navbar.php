                ...
                <ul class="list-unstyled">
                    <li class="dropdown pc-h-item header-user-profile">
                        <a
                            ...
                            aria-expanded="false">
                            <img
                                src="<?= $base_url ?>/assets/img/Logo-Merah.png"
                                alt="user-image"
                                class="user-avtar" />
                        ...
                        <div
                            ...
                            <div class="tab-content" id="mysrpTabContent">
                                <div
                                    ...
                                    tabindex="0">
                                    <a href="<?= $base_url ?>/manager/profile/index.php" class="dropdown-item">
                                        <i class="ti ti-user"></i>
                                        <span>Lihat Profil</span>
                                    </a>
                                    <a href="<?= $base_url ?>/manager/aktivitas.php" class="dropdown-item">
                                        <i class="ti ti-activity"></i>
                                        <span>Aktivitas</span>
                                    </a>
                                    <a href="<?= $base_url ?>/manager/master_data.php" class="dropdown-item">
