...
// Fungsi untuk cek apakah data koko sudah ada untuk produk tertentu
...
// Fungsi untuk mendapatkan stok koko
...
// Fungsi untuk update hutang upah TANPA PERIODE (tambah hutang)
...
// ✅ FUNGSI BARU: untuk mengurangi hutang upah penjahit dengan validasi
    ...
    WHERE hp.id_hasil_potong_fix = $id_hasil_potong_fix")[0];
        ...
        try {
            ...
            if ($tipe_produk == 'mukena' && $total_hasil_jahit > 0) {
                ...
                // Pertama, cek stok saat ini
                $stok_sekarang = getStokKoko($id_produk);
                ...
                WHERE id_produk = $id_produk";
                    ...
                    if (!$conn->query($sql_kurangi_stok)) {
                        throw new Exception("Gagal mengurangi stok koko: " . $conn->error);
                    }
                    $pesan_stok = "Stok koko dikurangi -$total_hasil_jahit";
                } else {
    ...
    WHERE hp.id_hasil_potong_fix = $id_hasil_potong_fix")[0];
        ...
        try {
            ...
            if ($tipe_produk == 'mukena' && $total_hasil_jahit > 0) {
                ...
                // KOKO: Kurangi stok koko (TIDAK menghapus, hanya kurangi stok)
                // Pertama, cek stok saat ini
                $stok_sekarang = getStokKoko($id_produk);
                ...
                WHERE id_produk = $id_produk";
                    ...
                    // Jika stok tidak cukup, hapus record
                    $sql_hapus_koko = "DELETE FROM koko WHERE id_produk = $id_produk";
                    if (!$conn->query($sql_hapus_koko)) {
                        throw new Exception("Gagal menghapus data koko: " . $conn->error);
                    }
                    $pesan_stok = "data koko dihapus";
                }
            }
        ...
        <div class="pc-content">
            <div class="row">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="btn-group">
                        <div>
                            <a href="finishing.php" class="btn btn-primary me-1">
                                <i class="ti ti-circle-plus"></i> Finishing Koko
                            </a>
                        </div>
                        <div>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group-actions text-center">
                                                    ...
                                                    <?php if ($is_diproses): ?>
                                                        ...
                                                        <!-- Di dalam loop foreach $all_data -->
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(e) {
                ...
                if (e.target.closest('.btn-batal-produksi')) {
                    ...
                    const tarifPemotong = 700; // Default atau ambil dari data atribut jika ada
                    ...
                    Swal.fire({
                        ...
                        html: `<div class="text-start">
                                ...
                                <div class="alert alert-warning mt-2">
                                    ...
                                    <p>Upah Pemotong: Rp ${upahPemotong.toLocaleString('id-ID')}</p>
                                </div>
                                <p class="text-danger"><strong>Tindakan ini tidak dapat dikembalikan!</strong></p>
                            </div>`,
                        icon: 'warning',
