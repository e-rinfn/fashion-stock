                ...
                <div class="col-lg-8 mb-4 order-1">
                    <div class="card">
                        <div class="d-flex align-items-end row">
                            <div class="col-sm-12">
                                <div class="card-body">
                                    <h5 class="card-title text-success">Selamat Datang, Owner</h5>
                                    <p class="mb-4" style="text-align: justify;">
                                        Selamat datang di dashboard sistem manajemen produksi Mukena dan Koko.
                                        Melalui halaman ini, Anda dapat melihat dan memantau seluruh data operasional
                                        yang meliputi proses produksi, pembelian bahan, penjualan produk, serta
                                        laporan dan arus kas secara menyeluruh. Dashboard ini bersifat informatif
                                        dan digunakan sebagai sarana monitoring untuk mendukung evaluasi dan
                        ...
                        <div class="row row-bordered g-0">
                            <div class="col-12">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="<?= $base_url ?>/owner/aktivitas.php" class="btn btn-sm btn-outline-primary">
