...
$page_title = "STOK KOKO UNTUK FINISHING";
        ...
        <div class="pc-content">
            ...
            <div class="row">
                ...
                <form method="GET" class="row g-3 mb-3">
                    <div class="col-md-6">
                        <input type="text" name="nama_koko" class="form-control" placeholder="Cari Nama Produk"
                            value="<?= htmlspecialchars($nama_koko) ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if (!empty($nama_koko) || $stok != 'all'): ?>
                            ...
                            <tbody>
                                ...
                                foreach ($koko as $p): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($p['nama_koko']) ?></td>
